            ...
            <div className={styles.imagesBlock}>
                {imagesWithId.map((image: { id: number, image: string }) => (
                    <div key={image.id} className={styles.imageContainer}>
                        <Link target="_blank" href={`https://sashestudio.ru:4300/images/gallery/${image.image}`}>
                            <Image
                                priority={true}
                                src={`https://sashestudio.ru:4300/images/gallery/${image.image}`}
                                alt={'image'}
                                width={240}
                                height={240}
                            />
            ...
            <div className={styles.firstImagesContainer}>
                {firstImages.map((image: string) => (
                    <div key={image} className={styles.imageContainer}>
                        <Link target="_blank" href={`https://sashestudio.ru:4300/images/${image}`}>
                            <Image
                                priority={true}
                                src={`https://sashestudio.ru:4300/images/${image}`}
                                alt={'Изображение'}
                                width={240}
                                height={240}
                            />
